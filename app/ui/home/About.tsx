              ...
              <div>
                ...
                <div className="flex flex-wrap justify-evenly items-center">
                  <div className="w-full md:w-1/2 pr-5">
                    <h2 className={`text-2xl mb-5 ${satisfy.className}`}>
                      Visi
                    </h2>
                    <p>
                ...
                <div className="flex flex-wrap mt-10 justify-evenly items-center">
                  <div className="w-full md:w-1/2 pl-5 md:order-2">
                    <h2 className={`text-2xl mb-3 ${satisfy.className}`}>
                      Misi
                    </h2>
                    <ol className="pl-5 list-decimal text-sm md:text-base">
                      <li>
                        Mengutamakan keimanan dan ketakwaan kepada Tuhan Yang
                        Maha Esa, dan mengimplementasikan asas-asas Pancasila di
                        berbagai aspek kegiatan.
                      </li>
                      <li>
                        Menjadikan Pengurus OSIS sebagai penghubung koordinasi
                        yang terbuka dan bertanggung jawab dalam meningkatkan
                        komunikasi di setiap komponen OSIS.
                      </li>
                      <li>
                        Menciptakan program kerja dan kegiatan yang efektif
                        berdasarkan aspirasi serta kebutuhan SMK Telkom Makassar
                        dengan kolaborasi antara pihak internal dan eksternal
                        OSIS.
                      </li>
                      <li>
                        Meningkatkan kinerja dan kualitas ekstrakurikuler
                        sekolah guna membentuk siswa/i kompeten dan progresif.
                      </li>
                      <li>
                        Mengoptimalkan fungsi sosial media sebagai sarana
                        informatif berbasis online.
                      </li>
                      <li>
