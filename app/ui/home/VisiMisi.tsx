        ...
        <div className="max-w-screen-lg container text-center">
          <div id="visi" className="mb-10">
            ...
            <p className="text-slate-50 text-sm">
              ...
              segala aspirasi, bakat, potensi dan kreativitas dengan pemanfaatn
              Ilmu Pengetahuan dan Teknologi (IPTEK), serta berakhlak mulia
              berlandaskan pancasila dengan mengedepankan Iman dan Taqwa
              (IMTAQ).
            </p>
          </div>
          ...
          <div id="misi">
            ...
            <ol className="list-decimal ml-5 text-justify">
              <li className="mb-2 text-slate-50 text-sm">
                Mengutamakan keimanan dan ketakwaan kepada Tuhan Yang Maha Esa,
                dan mengimplementasikan asas-asas Pancasila di berbagai aspek
                kegiatan.
              </li>
              <li className="mb-2 text-slate-50 text-sm">
              ...
              <li className="mb-2 text-slate-50 text-sm">
                Menciptakan program kerja dan kegiatan yang efektif berdasarkan
                aspirasi serta kebutuhan SMK Telkom Makassar dengan kolaborasi
                antara pihak internal dan eksternal OSIS.
              </li>
              <li className="mb-2 text-slate-50 text-sm">
