          ...
          <div className="flex flex-wrap items-center">
            <div className="w-full md:w-1/2">
              <h1 className="text-2xl md:text-3xl font-extrabold uppercase mb-10">
                Belajar dan Bekerja Bersama dalam Tim untuk menyukseskan Program
                Kerja
              </h1>
              <p>
                Dalam OSIS kita belajar dan bekerja bersama dalam setiap Program
                Kerja yang telah direncanakan. Mulai dari perencanaan,
                pembiayaan, pembentukan panitia hingga saat kegiatan
                berlangsung. Semua juga tidak lepas dibawah bimbingan para guru
                yang berperan sebagai pendamping pengurus OSIS.
              </p>
            </div>
