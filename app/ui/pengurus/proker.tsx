export default function Proker() {
  return (
    <div className="min-h-screen container py-40 bg-primary text-white">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 justify-center">
        ...
        <div className="p-5">
          ...
          <p className="text-sm text-justify text-slate-50">
            ...
            keislaman seperti cara berwudhu dan bertayamum yang benar, mendalami
            Al-Quran, mendengarkan ceramah, serta tambahan ice breaking.
          </p>
        </div>
        <div className="p-5">
          ...
          <p className="text-sm text-justify">
            Kegiatan ini akan dirangkaikan dengan beberapa kegiatan seperti,
            beribadah dan games dengan konsep tema paskah seperti mencari telur,
            jalan obor, Cerdas Cermat Alkitab (CCA), dan sebagainya.
          </p>
        </div>
        <div className="p-5">
          <h1 className="text-2xl font-bold mb-2">Maulid Nabi Muhammad SAW</h1>
          <p className="text-sm text-justify">
